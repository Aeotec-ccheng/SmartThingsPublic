...
metadata {
	definition(name: "Aeotec Multisensor 7", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.020.00008', executeCommandsLocally: true, ocfDeviceType: "x.com.st.d.sensor.motion") {
        ...
        fingerprint mfr: "0371", prod: "0102", model: "0018", deviceJoinName: "Aeotec Multipurpose Sensor" //US //Aeotec MultiSensor 7
		fingerprint mfr: "0371", prod: "0202", model: "0018", deviceJoinName: "Aeotec Multipurpose Sensor" //AU //Aeotec MultiSensor 7
        fingerprint mfr: "0371", prod: "0002", model: "0018", deviceJoinName: "Aeotec Multipurpose Sensor" //EU //Aeotec MultiSensor 7
	}
	...
	preferences {
		input "motionRetriggerTime", "enum", title: "Motion Presence Retrigger Time",
			options: ["0 seconds", "30 seconds", "40 seconds", "1 minute", "2 minutes", "3 minutes", "4 minutes"]
...
def configure() {
	...
	//2. presence motion retrigger time (keeps motion triggered)
    request << zwave.configurationV1.configurationSet(parameterNumber: 2, size: 2, scaledConfigurationValue: timeOptionValueMap[motionRetriggerTime] ?: 0)
